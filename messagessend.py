...
message_body = "This is Alex w/ Sunrise San Diego. This Friday (1/22), we are hosting a Green New Decade livestream (bit.ly/SDGNDecade) about our city government, where they have historically failed, and how we want to see them do better! As far as accessibility, we will have an ASL interpreter, captions, and a break in the middle. Will you join us at 6-8PM Pacific?"
